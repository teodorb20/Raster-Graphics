...
void PBMImage::Negative(const char* nameImage, const char* typeOfImage)
{
...
void PBMImage::Rotate(const char* direction, const char* nameImage, const char* typeOfImage)
{
...
void PBMImage::Add(const char* nameImage, const char* typeOfImage)
{
	std::cout << "Image " << '"' << nameImage << "." << typeOfImage << '"' << " added." << std::endl;
}

void PBMImage::Collage(const char* direction, const char* collageName, const char* typeOfImage)
{
...
void PBMImage::collageHorizontal()
{
	for (int i = 0; i < m_rows; i++) {
		for (int j = 0; j < m_cols; j++) {
